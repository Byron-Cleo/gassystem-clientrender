...
import GasForRefillNavigationBar from './../components/GasForRefillNavigationBar';

const GasRefillDashboardScreen = () => {
  return (
    <div className="container">
          ...
          <div className="card spur-card">
            <div className="card-header">
              ...
              <div className="spur-card-title">
                Gas To Be Refilled Analytics Overview
              </div>
            </div>
      ...
      <GasForRefillNavigationBar />
    </div>
  );
};

export default GasRefillDashboardScreen;
